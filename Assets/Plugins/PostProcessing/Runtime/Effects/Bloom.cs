...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    {
        //‘ŸΩµ∑÷±Ê¬ 
        public static int dropDonwload = 2;
        /// <summary>
    ...
    internal sealed class BloomRenderer : PostProcessEffectRenderer<Bloom>
    {
        ...
        public override void Render(PostProcessRenderContext context)
        {
            ...
            int tw = Mathf.FloorToInt(context.screenWidth / Bloom.dropDonwload / (2f - rw));
            int th = Mathf.FloorToInt(context.screenHeight / Bloom.dropDonwload / (2f - rh));
