...
namespace TMPro.EditorUtilities
{
    ...
    public class TMP_SubMeshUI_Editor : Editor
    {
        ...
        private SerializedProperty s_IsCanSortingMask;
        //private SerializedProperty m_ParentMask;
        ...
        public void OnEnable()
        {
            ...
            //m_ParentMask = serializedObject.FindProperty("m_ParentMask");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(s_IsCanSortingMask);
            //EditorGUILayout.PropertyField(m_ParentMask);
            GUI.enabled = true;
