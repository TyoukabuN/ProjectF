...
{
    public class TMP_SDFShaderGUI_X : TMP_BaseShaderGUI
    {
        ...
        void DoOutlinePanel()
        {
            ...
            DoSlider("_OutlineWidthEX", "OutlineWidth");
            DoSlider("_OutlineBrightness", "OutlineBrightness");
        ...
        void DoDebugPanel()
        {
            ...
            if (m_Material.HasProperty(ShaderUtilities.ID_MainChannel))
            {
                EditorGUILayout.Space();
                DoPopup("_MainChannel", "Channel", s_Channel);
                EditorGUILayout.Space();
            }
