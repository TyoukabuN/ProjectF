...
namespace TMPro.EditorUtilities
{
    ...
    public class TMP_SpriteCharacterPropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            SerializedProperty prop_SpriteCharCode = property.FindPropertyRelative("m_CharCode");
            ...
            if (GUI.enabled == false)
            {
                ...
                EditorGUI.LabelField(new Rect(rect.x + 75f, rect.y + 36, 80, 18), new GUIContent("Char: <color=#FFFF80>" + prop_SpriteCharCode.intValue + "</color>"), style);
            ...
            else // Display editable fields
            {
                ...
                EditorGUIUtility.labelWidth = 39f;
                EditorGUI.BeginChangeCheck();
                EditorGUI.PropertyField(new Rect(rect.x + 100f, rect.y + 36, 100, 18), prop_SpriteCharCode, new GUIContent("Char:"));
                if (EditorGUI.EndChangeCheck())
                {
                    char code = Convert.ToChar(prop_SpriteCharCode.intValue);
                    int intCode = Convert.ToInt32(code);
                    prop_SpriteUnicode.intValue = intCode;
                    spriteAsset.m_IsSpriteAssetLookupTablesDirty = true;
                }
