...
namespace TMPro.EditorUtilities
{
    public abstract class TMP_BaseEditorPanel : Editor
    {
        ...
        static readonly GUIContent k_IsCanSortingMask = new GUIContent("CanSortingMask", "勾上用了sorting order也可以在2d mask里消失");

        static readonly GUIContent k_FaceColor = new GUIContent("FaceColor");
        static readonly GUIContent k_UseOutlineLabel = new GUIContent("UseOutline");
        static readonly GUIContent k_OutlineColorLabel = new GUIContent("OutlineColor");
        static readonly GUIContent k_UseShadowLabel = new GUIContent("UseShadow");
        static readonly GUIContent k_ShadowColorLabel = new GUIContent("ShadowColor");
        ...
        protected static readonly GUIContent K_MaterialSettingLabel = new GUIContent("Material Setting");

        static readonly GUIContent k_IsStaticLabel = new GUIContent("IsStatic", "testEditor the text to fit the available space.");
        static readonly GUIContent k_LanguageIdLabel = new GUIContent("Language ID", "The languageId the text will be rendered at in points.");
        static readonly GUIContent k_NotlinkIdCallEventLabel = new GUIContent("NotlinkIdCallEvent", "testEditor the text to fit the available space.");

        static readonly GUIContent k_IgnoreAttachingCanvas = new GUIContent("Ignore Attaching Canvas", "skip own gameObject attaching Canvas when FindRootSortOverrideCanvas");
        protected struct Foldout
        {
            // Track Inspector foldout panel states, globally.
            public static bool extraSettings = false;
            public static bool materialSettings = false;
        ...
        protected SerializedProperty m_FontMaterialProp;
        protected SerializedProperty m_CacheMaterialProp;
        protected SerializedProperty m_BeforeMaterialProp;
        ...
        protected SerializedProperty m_isStaticProp;
        protected SerializedProperty m_languageIdProp;
        protected SerializedProperty m_notlinkIdCallEventProp;
        protected SerializedProperty m_IgnoreAttachingCanvas;

        //face
        SerializedProperty m_faceColorProp;
        SerializedProperty m_faceSoftnessProp;
        SerializedProperty m_faceDilateProp;

        //outline
        SerializedProperty m_useOutlineProp;
        SerializedProperty m_outlineColorProp;
        SerializedProperty m_outlineThicknessProp;
        SerializedProperty m_outlineWidthProp;
        SerializedProperty m_outlineBrightnessProp;

        //underlay
        SerializedProperty m_useUnderlayProp;
        SerializedProperty m_underlayColorProp;
        SerializedProperty m_underlayOffsetXProp;
        SerializedProperty m_underlayOffsetYProp;
        SerializedProperty m_underlayDilateProp;
        SerializedProperty m_underlaySoftnessProp;

        //protected SerializedProperty m_outlineThicknessProp;
        //protected SerializedProperty m_outlineWidthProp;
        //protected SerializedProperty m_outlineBrightnessProp;
        ...
        protected SerializedProperty s_IsCanSortingMask;
        ...
        protected virtual void OnEnable()
        {
            ...
            m_FontMaterialProp = serializedObject.FindProperty("m_fontMaterial");
            m_CacheMaterialProp = serializedObject.FindProperty("m_CacheMaterial");
            m_BeforeMaterialProp = serializedObject.FindProperty("m_BeforeMaterial");
            ...
            m_isStaticProp = serializedObject.FindProperty("m_isStatic");
            m_languageIdProp = serializedObject.FindProperty("m_languageId");
            m_notlinkIdCallEventProp = serializedObject.FindProperty("m_notlinkIdCallEvent");
            m_IgnoreAttachingCanvas = serializedObject.FindProperty("m_IgnoreAttachingCanvas");

            m_faceColorProp = serializedObject.FindProperty("m_faceColor");
            m_faceSoftnessProp = serializedObject.FindProperty("m_faceSoftness");
            m_faceDilateProp = serializedObject.FindProperty("m_faceDilate");

            m_useOutlineProp = serializedObject.FindProperty("m_useOutline");
            ...
            m_outlineWidthProp = serializedObject.FindProperty("m_outlineWidth");
            m_outlineBrightnessProp = serializedObject.FindProperty("m_outlineBrightness");

            m_useUnderlayProp = serializedObject.FindProperty("m_useUnderlay");
            m_underlayColorProp = serializedObject.FindProperty("m_underlayColor");
            m_underlayOffsetXProp = serializedObject.FindProperty("m_underlayOffsetX");
            m_underlayOffsetYProp = serializedObject.FindProperty("m_underlayOffsetY");
            m_underlayDilateProp = serializedObject.FindProperty("m_underlayDilate");
            m_underlaySoftnessProp = serializedObject.FindProperty("m_underlaySoftness");
            //m_outlineThicknessProp = serializedObject.FindProperty("m_outlineThickness");
            //m_outlineWidthProp = serializedObject.FindProperty("m_outlineWidth");
            //m_outlineBrightnessProp = serializedObject.FindProperty("m_outlineBrightness");
            //m_shadowColorProp = serializedObject.FindProperty("m_shadowColor");
            //m_shadowOffsetXProp = serializedObject.FindProperty("m_shadowOffsetX");
            //m_shadowOffsetYProp = serializedObject.FindProperty("m_shadowOffsetY");
            ...
            s_IsCanSortingMask = serializedObject.FindProperty("s_IsCanSortingMask");
        ...
        protected abstract void DrawMaterialSettings();
        ...
        protected void DrawTextureMapping()
        {
            ...
            EditorGUILayout.PropertyField(m_isStaticProp, k_IsStaticLabel);
            EditorGUILayout.PropertyField(m_languageIdProp, k_LanguageIdLabel, GUILayout.MaxWidth(EditorGUIUtility.labelWidth + 70f));
            EditorGUILayout.PropertyField(m_notlinkIdCallEventProp, k_NotlinkIdCallEventLabel);
            if (m_IgnoreAttachingCanvas != null)
                EditorGUILayout.PropertyField(m_IgnoreAttachingCanvas, k_IgnoreAttachingCanvas);
            if (EditorGUI.EndChangeCheck())
            {
                m_HavePropertiesChanged = true;
            }
        ...
        protected void DrawCanSortingMask()
        {
            // EXTRA CanSortingMask
            EditorGUI.BeginChangeCheck();
            EditorGUILayout.PropertyField(s_IsCanSortingMask, k_IsCanSortingMask);
            if (EditorGUI.EndChangeCheck())
            {
                ...
                {
                    TMP_SubMeshUI subMeshUI = graphicComponents[i] as TMP_SubMeshUI;
                    if (subMeshUI != null)
                    {
                        subMeshUI.s_IsCanSortingMask = s_IsCanSortingMask.boolValue;
                    }
                }
            }
        }

        protected void DrawMaterial()
        {
            //EditorGUILayout.PropertyField(m_faceColorProp, k_FaceColor);
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Face Softness", GUILayout.MaxWidth(135));
            m_faceSoftnessProp.floatValue = EditorGUILayout.Slider(m_faceSoftnessProp.floatValue, 0f, 1f);
            EditorGUILayout.EndHorizontal();

            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Face Dilate", GUILayout.MaxWidth(135));
            m_faceDilateProp.floatValue = EditorGUILayout.Slider(m_faceDilateProp.floatValue, -1f, 1f);
            EditorGUILayout.EndHorizontal();

            if (m_useOutlineProp != null)
            {
                EditorGUI.BeginChangeCheck();
                EditorGUILayout.PropertyField(m_useOutlineProp, k_UseOutlineLabel);
                if (EditorGUI.EndChangeCheck())
                {
                    m_HavePropertiesChanged = true;
                }
                EditorGUI.BeginChangeCheck();
                if (m_useOutlineProp.boolValue)
                {
                    EditorGUI.indentLevel++;
                    EditorGUILayout.PropertyField(m_outlineColorProp, k_OutlineColorLabel);

                    EditorGUILayout.BeginHorizontal();
                    EditorGUILayout.LabelField("Thickness", GUILayout.MaxWidth(135));
                    m_outlineThicknessProp.floatValue = EditorGUILayout.Slider(m_outlineThicknessProp.floatValue, 0f, 1f);
                    EditorGUILayout.EndHorizontal();

                    EditorGUILayout.BeginHorizontal();
                    EditorGUILayout.LabelField("OutlineWidth", GUILayout.MaxWidth(135));
                    m_outlineWidthProp.floatValue = EditorGUILayout.Slider(m_outlineWidthProp.floatValue, 0f, 1f);
                    EditorGUILayout.EndHorizontal();

                    EditorGUILayout.BeginHorizontal();
                    EditorGUILayout.LabelField("OutlineBrightness", GUILayout.MaxWidth(135));
                    m_outlineBrightnessProp.floatValue = EditorGUILayout.Slider(m_outlineBrightnessProp.floatValue, 1f, 5f);
                    EditorGUILayout.EndHorizontal();
            ...
            if (m_useUnderlayProp != null)
            {
                EditorGUI.BeginChangeCheck();
                EditorGUILayout.PropertyField(m_useUnderlayProp, k_UseShadowLabel);
                if (EditorGUI.EndChangeCheck())
                {
                    m_HavePropertiesChanged = true;
                }
                EditorGUI.BeginChangeCheck();
                if (m_useUnderlayProp.boolValue)
                {
                    EditorGUI.indentLevel++;
                    EditorGUILayout.PropertyField(m_underlayColorProp, k_ShadowColorLabel);

                    EditorGUILayout.BeginHorizontal();
                    EditorGUILayout.LabelField("Offset X", GUILayout.MaxWidth(135));
                    m_underlayOffsetXProp.floatValue = EditorGUILayout.Slider(m_underlayOffsetXProp.floatValue, -2f, 2f);
                    EditorGUILayout.EndHorizontal();

                    EditorGUILayout.BeginHorizontal();
                    EditorGUILayout.LabelField("Offset Y", GUILayout.MaxWidth(135));
                    m_underlayOffsetYProp.floatValue = EditorGUILayout.Slider(m_underlayOffsetYProp.floatValue, -2f, 2f);
                    EditorGUILayout.EndHorizontal();

                    EditorGUILayout.BeginHorizontal();
                    EditorGUILayout.LabelField("Dilate", GUILayout.MaxWidth(135));
                    m_underlayDilateProp.floatValue = EditorGUILayout.Slider(m_underlayDilateProp.floatValue, -2f, 2f);
                    EditorGUILayout.EndHorizontal();

                    EditorGUILayout.BeginHorizontal();
                    EditorGUILayout.LabelField("Softness", GUILayout.MaxWidth(135));
                    m_underlaySoftnessProp.floatValue = EditorGUILayout.Slider(m_underlaySoftnessProp.floatValue, 0f, 1f);
                    EditorGUILayout.EndHorizontal();
