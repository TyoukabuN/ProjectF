...
namespace TMPro
{
    public static class ShaderUtilities
    {
        ...
        public static int ID_OutlineThickness;
        public static int ID_OutlineBrightness;
        ...
        public static int ID_MainChannel;
        ...
        public static void GetShaderPropertyIDs()
        {
            if (isInitialized == false)
            {
                ...
                ID_OutlineWidth = Shader.PropertyToID("_OutlineWidthEX");
                ID_OutlineSoftness = Shader.PropertyToID("_OutlineSoftness");
                ID_OutlineColor = Shader.PropertyToID("_OutlineColor");
                ID_OutlineThickness = Shader.PropertyToID("_OutlineWidth");
                ID_OutlineBrightness = Shader.PropertyToID("_OutlineBrightness");
        ...
        public static void UpdateShaderRatios(Material mat, TMP_Text tmpText)
        {
            ...
            float faceDilate = tmpText.GetFaceDilate();
            float outlineThickness = tmpText.GetOutlineThickness();
            //float outlineSoftness = mat.GetFloat(ID_OutlineSoftness);
            float outlineSoftness = tmpText.GetOutlineSoftnees();
            ...
            if (mat.HasProperty(ID_UnderlayOffsetX))
            {
                ...
                float underlayOffsetX = tmpText.GetUnderlayOffsetX();
                float underlayOffsetY = tmpText.GetUnderlayOffsetY();
                float underlayDilate = tmpText.GetUnderlayDilate();
                float underlaySoftness = tmpText.GetUnderlaySoftness();
        ...
        public static float GetPadding(Material material, bool enableExtraPadding, bool isBold, TMP_Text tmpText)
        {
            ...
            UpdateShaderRatios(material, tmpText);

            string[] shaderKeywords = material.shaderKeywords;

            //if (material.HasProperty(ID_ScaleRatio_A))
            scaleRatio_A = tmpText.ScaleRatio_A;
                 //= material.GetFloat(ID_ScaleRatio_A);
            ...
            faceDilate = tmpText.GetFaceDilate() * scaleRatio_A;

            //if (material.HasProperty(ID_OutlineSoftness))
            faceSoftness = tmpText.GetOutlineSoftnees() * scaleRatio_A;

            if (material.HasProperty(ID_OutlineWidth))
                outlineThickness = tmpText.GetOutlineWidth() * scaleRatio_A;
            ...
            if (material.HasProperty(ID_UnderlaySoftness)) // Generates GC
            {
                //if (material.HasProperty(ID_ScaleRatio_C))
                scaleRatio_C = tmpText.ScaleRatio_C;

                float offsetX = tmpText.GetUnderlayOffsetX() * scaleRatio_C;
                float offsetY = tmpText.GetUnderlayOffsetY() * scaleRatio_C;
                float dilate = tmpText.GetUnderlayDilate() * scaleRatio_C;
                float softness = tmpText.GetUnderlaySoftness() * scaleRatio_C;
        ...
        // Function to determine how much extra padding is required as a result of material properties like dilate, outline thickness, softness, glow, etc...
        public static float GetPadding(Material[] materials, bool enableExtraPadding, bool isBold, TMP_Text tmpText)
        {
            //Debug.Log("GetPadding() called.");
            ...
            {
                // Update Shader Ratios prior to computing padding
                ShaderUtilities.UpdateShaderRatios(materials[i], tmpText);
