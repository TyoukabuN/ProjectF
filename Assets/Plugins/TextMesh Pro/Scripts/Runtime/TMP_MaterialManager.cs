...
namespace TMPro
{
    ...
    public static class TMP_MaterialManager
    {
        ...
        public static Material GetFallbackMaterial (Material sourceMaterial, Material targetMaterial)
        {
            ...
            if (targetMaterial.HasProperty(ShaderUtilities.ID_MainChannel))
            {
                fallbackMaterial.SetInt(ShaderUtilities.ID_MainChannel, targetMaterial.GetInt(ShaderUtilities.ID_MainChannel));
            }
