...
namespace TMPro
{
    ...
    public struct TMP_MeshInfo
    {
        ...
        public TMP_MeshInfo(Mesh mesh, int size)
        {
            ...
            while (index_X4 / 4 < size)
            {
                for (int i = 0; i < 4; i++)
                {
                    ...
                    this.uvs1[index_X4 + i] = Vector2.zero;
        ...
        public TMP_MeshInfo(Mesh mesh, int size, bool isVolumetric)
        {
            ...
            this.uvs1 = new Vector2[size_x_s0];
            ...
            while (index_x_s0 / s0 < size)
            {
                for (int i = 0; i < s0; i++)
                {
                    ...
                    this.uvs1[index_x_s0 + i] = Vector2.zero;
        ...
        public void ResizeMeshInfo(int size)
        {
            ...
            Array.Resize(ref this.uvs1, size_X4);
        ...
        public void SwapVertexData(int src, int dst)
        {
            ...
            //Swap UVs1
            Vector4 uvs;
            uvs = uvs1[dst_Index + 0];
            uvs1[dst_Index + 0] = uvs1[src_Index + 0];
            uvs1[src_Index + 0] = uvs;

            uvs = uvs1[dst_Index + 1];
            uvs1[dst_Index + 1] = uvs1[src_Index + 1];
            uvs1[src_Index + 1] = uvs;

            uvs = uvs1[dst_Index + 2];
            uvs1[dst_Index + 2] = uvs1[src_Index + 2];
            uvs1[src_Index + 2] = uvs;

            uvs = uvs1[dst_Index + 3];
            uvs1[dst_Index + 3] = uvs1[src_Index + 3];
            uvs1[src_Index + 3] = uvs;
