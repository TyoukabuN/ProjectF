...
namespace TMPro
{
    ...
    public abstract class TMP_Text : MaskableGraphic
    {
        ...
        [SerializeField]
        protected ColorMode m_colorMode = ColorMode.VerticalGradient;
        ...
        [SerializeField]
        protected float m_fontSize = 24; // Font Size
        ...
        public bool isStatic
        {
            ...
            set { if (m_isStatic == value) return; m_havePropertiesChanged = true; m_isStatic = value; SetVerticesDirty(); }
        }
        [SerializeField]
        ...
        public int languageId
        {
            ...
            set { if (m_languageId == value) return; m_havePropertiesChanged = true; m_isCalculateSizeRequired = true; m_languageId = value; SetVerticesDirty(); SetLayoutDirty(); }
        }
        [SerializeField]
        protected int m_languageId = 0; // Font Size

        public bool notlinkIdCallEvent
        {
            get { return m_notlinkIdCallEvent; }
            set { if (m_notlinkIdCallEvent == value) return; m_havePropertiesChanged = true; m_notlinkIdCallEvent = value; SetVerticesDirty(); }
        }
        [SerializeField]
        protected bool m_notlinkIdCallEvent = false;
        ...
        //face softness [0]-[1] defalut 0
        [SerializeField]
        protected float m_faceSoftness = 0f;

        public float faceSoftness { set { m_faceSoftness = value; } get { return m_faceSoftness; } }

        //face Dilate [-1]-[1] defalut 0
        [SerializeField]
        protected float m_faceDilate = 0f;
        public float faceDilate { set { m_faceDilate = value; } get { return m_faceDilate; } }

        //使用描边
        [SerializeField]
        protected bool m_useOutline = false;

        public bool useOutline { set { m_useOutline = value; } get { return m_useOutline; } }

        //描边颜色
        [SerializeField]
        protected Color32 m_outlineColor = Color.black;

        //描边Thickness [0]-[1] defalut 1
        [SerializeField]
        protected float m_outlineThickness = 1f;
        public float outlineThickness { set { m_outlineThickness = value; } get { return m_outlineThickness; } }

        //描边Width [0]-[1] defalut 1
        [SerializeField]
        protected float m_outlineWidth = 1f;

        //描边Brightness [1]-[5] defalut 1.5
        [SerializeField]
        protected float m_outlineBrightness = 1.5f;

        public float outlineBrightness { set { m_outlineBrightness = value; } get { return m_outlineBrightness; } }

        //使用underlay 
        [SerializeField]
        protected bool m_useUnderlay = false;
        public bool useUnderlay { set { m_useUnderlay = value; } get { return m_useUnderlay; } }

        //underlay颜色
        [SerializeField]
        protected Color32 m_underlayColor = Color.black;
        public Color32 underlayColor { set { m_underlayColor = value; } get { return m_underlayColor; } }

        //underlay OffsetX [-2]-[2] defalut 0
        [SerializeField]
        protected float m_underlayOffsetX = 0f;
        public float underlayOffsetX { set { m_underlayOffsetX = value; } get { return m_underlayOffsetX; } }

        //underlay OffsetY [-2]-[2] defalut 0
        [SerializeField]
        protected float m_underlayOffsetY = 0f;
        public float underlayOffsetY { set { m_underlayOffsetY = value; } get { return m_underlayOffsetY; } }

        //underlay Dilate [-2]-[2] defalut 0f
        [SerializeField]
        protected float m_underlayDilate = 0f;
        public float underlayDilate { set { m_underlayDilate = value; } get { return m_underlayDilate; } }

        //underlay Softness [0]-[1] defalut 0f
        [SerializeField] 
        protected float m_underlaySoftness;
        public float underlaySoftness { set { m_underlaySoftness = value; } get { return m_underlaySoftness; } }

        public float ScaleRatio_A;
        public float ScaleRatio_C;

        //需要和TMP_SDF-Mobile_X.shader保持一致
        ...
        public float GetOutlineSoftnees()
        {
            return m_faceSoftness;
        }

        public float GetUnderlayOffsetX()
        {
            return m_underlayOffsetX;
        }

        public float GetUnderlayOffsetY()
        {
        ...
        private char[] m_htmlTagArray;

        protected char[] m_htmlTag 
        {
            get
            {
                if (m_htmlTagArray == null)
                {
                    int length = 128;
                    var tagSizeSetting = gameObject.GetComponent<TMP_HtmlTagSizeSetting>();
                    if (tagSizeSetting)
                    {
                        length = tagSizeSetting.HtmlTagSize;
                    }
                    m_htmlTagArray = new char[length];// Maximum length of rich text tag. This is preallocated to avoid GC.
                }
                return m_htmlTagArray;
            }
        }
            ...
            for (int i = 0; m_TextParsingBuffer[i].unicode != 0; i++)
            {
                ...
                if (m_enableKerning)
                {
                    ...
                    if (m_characterCount < totalCharacterCount - 1)
                    {
                        ...
                        if (m_textInfo.characterInfo[m_characterCount + 1].textElement != null)
                        {
        ...
        Vector3 normalsRGB = Vector3.zero;
        Vector4 tangentColor = Vector4.zero;
        Vector2 uvs3 = Vector2.zero;
        Vector2 uvs4 = Vector2.zero;

        void EncodeInt(out int outlineInt,out int underlayInt,out int param1,out int param2,out int param3)
        {
            outlineInt = (int)(m_outlineColor.r / 255.0f * 0xff) << 16 | (int)(m_outlineColor.g / 255.0f * 0xff) << 8 | (int)(m_outlineColor.b / 255.0f * 0xff);
            underlayInt = (int)(m_underlayColor.r / 255.0f * 0xff) << 16 | (int)(m_underlayColor.g / 255.0f * 0xff) << 8 | (int)(m_underlayColor.b / 255.0f * 0xff);
            param1 = (int)(m_faceSoftness * 0x3f) << 18 | (int)((m_faceDilate + 1) / 2 * 0x3f) << 12 | (int)(m_outlineThickness * 0x3f) << 6 | (int)(m_outlineWidth * 0x3f);
            param2 = (int)((m_outlineBrightness - 1) / 4 * 0x3f) << 18 | (int)((m_underlayOffsetX + 2) / 4 * 0x3f) << 12 | (int)((m_underlayOffsetY + 2) / 4 * 0x3f) << 6 | (int)((m_underlayDilate + 2) / 4 * 0x3f);
            param3 = (int)(m_underlaySoftness * 0x3f) << 18 | (int)(m_outlineColor.a / 255.0f * 0x3f) << 12 | (int)(m_underlayColor.a / 255.0f * 0x3f) << 6 | (int)((m_useOutline ? 1 : 0) * 0x7) << 3 | (int)((m_useUnderlay ? 1 : 0) * 0x7);
        }
        ...
        /// 
        protected PixelParamMap PixelParamMap;
        ...
        protected virtual void FillCharacterVertexBuffers(int i, int index_X4)
        {
            ...
            // Setup UVS0
            m_textInfo.meshInfo[materialIndex].uvs1[0 + index_X4] = characterInfoArray[i].vertex_BL.uv;
            m_textInfo.meshInfo[materialIndex].uvs1[1 + index_X4] = characterInfoArray[i].vertex_TL.uv;
            m_textInfo.meshInfo[materialIndex].uvs1[2 + index_X4] = characterInfoArray[i].vertex_TR.uv;
            m_textInfo.meshInfo[materialIndex].uvs1[3 + index_X4] = characterInfoArray[i].vertex_BR.uv;
            ...
            // Setup normals
            //int faceInt = (int)(m_faceColor.r / 255.0f  * 0xff) << 16 | (int)(m_faceColor.g / 255.0f * 0xff) << 8 | (int)(m_faceColor.b / 255.0f * 0xff);
            int outlineInt = 0;
            int underlayInt = 0;
            int param1 = 0;
            int param2 = 0;
            int param3 = 0;
            EncodeInt(out outlineInt, out underlayInt, out param1, out param2, out param3);
            //normalsRGB.Set(faceInt, outlineInt, underlayInt);
            //m_textInfo.meshInfo[materialIndex].normals[0 + index_X4] = normalsRGB;
            //m_textInfo.meshInfo[materialIndex].normals[1 + index_X4] = normalsRGB;
            //m_textInfo.meshInfo[materialIndex].normals[2 + index_X4] = normalsRGB;
            //m_textInfo.meshInfo[materialIndex].normals[3 + index_X4] = normalsRGB;
            if (PixelParamMap == null)
                PixelParamMap = new PixelParamMap(2, 2);

            UnityEngine.Profiling.Profiler.BeginSample("PixelParamMap.Apply");

            var color32 = new Color(outlineInt, param2, param3, param3);
            PixelParamMap.SetParam(0, color32, color32);
            PixelParamMap.Apply();

            UnityEngine.Profiling.Profiler.BeginSample("PixelParamMap.Apply");
            var color = PixelParamMap.GetPixel(0, 0);
            GetInstanceID();

            //PixelParamMap.SetParam(1, Color.blue, Color.yellow);
            //PixelParamMap.SetParam(0, Color.red, Color.green);

            PixelParamMap.OutputToPNG();


            // Setup tangents

            tangentColor.Set(outlineInt, param2, param3, param3);

            m_textInfo.meshInfo[materialIndex].tangents[0 + index_X4] = tangentColor;
            m_textInfo.meshInfo[materialIndex].tangents[1 + index_X4] = tangentColor;
            m_textInfo.meshInfo[materialIndex].tangents[2 + index_X4] = tangentColor;
            m_textInfo.meshInfo[materialIndex].tangents[3 + index_X4] = tangentColor;

            // Setup UVS3
            uvs3.Set(outlineInt, underlayInt);

            m_textInfo.meshInfo[materialIndex].uvs3[0 + index_X4] = uvs3;
            m_textInfo.meshInfo[materialIndex].uvs3[1 + index_X4] = uvs3;
            m_textInfo.meshInfo[materialIndex].uvs3[2 + index_X4] = uvs3;
            m_textInfo.meshInfo[materialIndex].uvs3[3 + index_X4] = uvs3;


            uvs4.Set(param1, param2);
            m_textInfo.meshInfo[materialIndex].uvs4[0 + index_X4] = uvs4;
            m_textInfo.meshInfo[materialIndex].uvs4[1 + index_X4] = uvs4;
            m_textInfo.meshInfo[materialIndex].uvs4[2 + index_X4] = uvs4;
            m_textInfo.meshInfo[materialIndex].uvs4[3 + index_X4] = uvs4;
        ...
        protected virtual void FillCharacterVertexBuffers(int i, int index_X4, bool isVolumetric)
        {
            ...
            if (isVolumetric)
            {
                m_textInfo.meshInfo[materialIndex].uvs1[4 + index_X4] = characterInfoArray[i].vertex_BL.uv;
                m_textInfo.meshInfo[materialIndex].uvs1[5 + index_X4] = characterInfoArray[i].vertex_TL.uv;
                m_textInfo.meshInfo[materialIndex].uvs1[6 + index_X4] = characterInfoArray[i].vertex_TR.uv;
                m_textInfo.meshInfo[materialIndex].uvs1[7 + index_X4] = characterInfoArray[i].vertex_BR.uv;
            }
        ...
        protected virtual void DrawUnderlineMesh(Vector3 start, Vector3 end, ref int index, float startScale, float endScale, float maxScale, float sdfScale, Color32 underlineColor)
        {
            ...
            // UNDERLINE UV0
            #region HANDLE UV0
            Vector2[] uvs0 = m_textInfo.meshInfo[0].uvs1;
            ...
            tangentColor.Set(param1, param2, param3, param3);

            m_textInfo.meshInfo[0].tangents[0 + index] = tangentColor;
            m_textInfo.meshInfo[0].tangents[1 + index] = tangentColor;
            m_textInfo.meshInfo[0].tangents[2 + index] = tangentColor;
            m_textInfo.meshInfo[0].tangents[3 + index] = tangentColor;

            m_textInfo.meshInfo[0].tangents[4 + index] = tangentColor;
            m_textInfo.meshInfo[0].tangents[5 + index] = tangentColor;
            m_textInfo.meshInfo[0].tangents[6 + index] = tangentColor;
            m_textInfo.meshInfo[0].tangents[7 + index] = tangentColor;

            m_textInfo.meshInfo[0].tangents[8 + index] = tangentColor;
            m_textInfo.meshInfo[0].tangents[9 + index] = tangentColor;
            m_textInfo.meshInfo[0].tangents[10 + index] = tangentColor;
            m_textInfo.meshInfo[0].tangents[11 + index] = tangentColor;


            // Setup UVS3
            uvs3.Set(outlineInt, underlayInt);

            m_textInfo.meshInfo[0].uvs3[0 + index] = uvs3;
            m_textInfo.meshInfo[0].uvs3[1 + index] = uvs3;
            m_textInfo.meshInfo[0].uvs3[2 + index] = uvs3;
            m_textInfo.meshInfo[0].uvs3[3 + index] = uvs3;

            m_textInfo.meshInfo[0].uvs3[4 + index] = uvs3;
            m_textInfo.meshInfo[0].uvs3[5 + index] = uvs3;
            m_textInfo.meshInfo[0].uvs3[6 + index] = uvs3;
            m_textInfo.meshInfo[0].uvs3[7 + index] = uvs3;

            m_textInfo.meshInfo[0].uvs3[8 + index] = uvs3;
            m_textInfo.meshInfo[0].uvs3[9 + index] = uvs3;
            m_textInfo.meshInfo[0].uvs3[10 + index] = uvs3;
            m_textInfo.meshInfo[0].uvs3[11 + index] = uvs3;


            uvs4.Set(param1, param2);
            m_textInfo.meshInfo[0].uvs4[0 + index] = uvs4;
            m_textInfo.meshInfo[0].uvs4[1 + index] = uvs4;
            m_textInfo.meshInfo[0].uvs4[2 + index] = uvs4;
            m_textInfo.meshInfo[0].uvs4[3 + index] = uvs4;

            m_textInfo.meshInfo[0].uvs4[4 + index] = uvs4;
            m_textInfo.meshInfo[0].uvs4[5 + index] = uvs4;
            m_textInfo.meshInfo[0].uvs4[6 + index] = uvs4;
            m_textInfo.meshInfo[0].uvs4[7 + index] = uvs4;

            m_textInfo.meshInfo[0].uvs4[8 + index] = uvs4;
            m_textInfo.meshInfo[0].uvs4[9 + index] = uvs4;
            m_textInfo.meshInfo[0].uvs4[10 + index] = uvs4;
            m_textInfo.meshInfo[0].uvs4[11 + index] = uvs4;
                        ...
                        for (int i = 0; i < m_xmlAttribute.Length && m_xmlAttribute[i].nameHashCode != 0; i++)
                        {
                            ...
                            switch (nameHashCode)
                            {
                                ...
                                case 26705: // ANIM
                                    ...
                                    if (paramCount == 1 && (int)m_attributeParameterValues[0] == -1)
                                    {
                                        if (m_spriteIndex < 0 || m_spriteIndex >= m_currentSpriteAsset.spriteInfoList.Count)
                                            return false;
                                        //anim="-1"
                                        if (m_isParsingText)
                                        {
                                            TMP_Sprite spriteInfo = m_currentSpriteAsset.spriteInfoList[m_spriteIndex];
                                            if (m_spriteIndex + spriteInfo.frameCount >= m_currentSpriteAsset.spriteInfoList.Count)
                                                break;
                                            spriteAnimator.DoSpriteAnimation(m_characterCount, m_currentSpriteAsset, m_spriteIndex, m_spriteIndex + spriteInfo.frameCount, spriteInfo.fps);
                                        }
                                    }
                                    else
                                    {
