...
namespace TMPro
{
    ...
    public partial class TextMeshProUGUI : TMP_Text, ILayoutElement
    {
        ...
        [SerializeField]
        public bool m_IsOutlineGray = false;

        [SerializeField]
        public Color m_SpriteTopColor = Color.red;

        [SerializeField]
        public Color m_SpriteBottomColor = Color.green;

        [SerializeField]
        public bool m_UseSpriteGradient = false;
        ...
        public override void UpdateVertexData(TMP_VertexDataUpdateFlags flags)
        {
            ...
            for (int i = 0; i < materialCount; i++)
            {
                ...
                if ((flags & TMP_VertexDataUpdateFlags.Uv0) == TMP_VertexDataUpdateFlags.Uv0)
                    mesh.uv = m_textInfo.meshInfo[i].uvs1;
