Shader "Custom/catlikecodeing_distortion_water"
{
    ...
    SubShader
    {
        ...
        sampler2D _MainTex,_FlowMap,_NoramlMap;
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            float3 normalA = UnpackNormal(tex2D(_NoramlMap,uvwA.xy)) * uvwA.z;
            float3 normalB = UnpackNormal(tex2D(_NoramlMap,uvwB.xy)) * uvwB.z;
